...
namespace TestReporter
{
    ...
    public class ExtentReporter : IReporter
    {
        ...
        private bool isGallopLogoRequired = true;
        ...
        public ExtentReporter(string filePath, bool replaceExisting, bool isGallopLogoRequired,string browser, string platform, IWebDriver webDriver = null)
        {
            ...
            this.objExtentReport.AddSystemInfo("Browser", browser);
            this.objExtentReport.AddSystemInfo("Platform", platform);
            ...
            if (webDriver != null)
            {
                driver = webDriver; // used for taking screenshot
            }
        }
        /// <summary>
        /// Gets the file path.
        ...
        {
            LogStatus status = this.objExtentTest.GetCurrentStatus();
            string statusText = "";
            switch (status)
            {
                case LogStatus.Pass:
