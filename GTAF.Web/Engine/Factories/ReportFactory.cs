        ...
        public static IReporter GetReport(string reportType = "ExtentReport", bool replaceExisting = true, bool isGallopLogoRequired = true)
        {
            ...
            {               
                ...
                default:
                    ...
                    report = new ExtentReporter(EngineSetup.TestReportFileName, replaceExisting, isGallopLogoRequired,EngineSetup.BROWSER,EngineSetup.PLATFORM, WebDriverFactory.getWebDriver());                    
                    break;
